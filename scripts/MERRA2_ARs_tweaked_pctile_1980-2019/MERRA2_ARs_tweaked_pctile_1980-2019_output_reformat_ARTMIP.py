...
def main(pctile, write_mask_file=True):

    artmip_input_dir = '/doppler/data7/kmattingly/AR_data_v2/ARTMIP_tier1/MERRA2_IVT_source_data/'
    ars_nh_dir = f'/doppler/data7/kmattingly/AR_data_v2/MERRA2_ARTMIP_polar_tweaked_pctiles/MERRA2_ARs_NH_3hr_pctile{pctile}/'
    ars_sh_dir = f'/doppler/data7/kmattingly/AR_data_v2/MERRA2_ARTMIP_polar_tweaked_pctiles/MERRA2_ARs_SH_3hr_pctile{pctile}/'
    ...
    output_dir_temp = f'/doppler/data7/kmattingly/AR_data_v2/MERRA2_ARTMIP_polar_tweaked_pctiles/MERRA2_ARs_pctile{pctile}_global_temp/'
    ...
    if write_mask_file:
        ...
        mask_ds.to_netcdf(f'{output_dir_comp}MERRA2.ar_mask.Mattingly_v2_pct{pctile}.nc4',
    ...
    for year in years:
        ...
        output_fname = f'MERRA2.ar_tag.Mattingly_v2_pct{pctile}.3hourly.{year}0101_{year}1231.nc4'
        ar_ds.to_netcdf(f'{output_dir_temp}{output_fname}',
                        encoding = {'lat':{'_FillValue':None}, 'lon':{'_FillValue':None}})
        
        now = dt.datetime.now()
        print(f'Finished reformatting {year} for pctile: {pctile} at {now}')
