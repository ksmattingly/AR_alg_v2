...
config_fpath = f'/home/kmattingly/projects/AR_alg_v2/scripts/CESM2-LE_ARTMIP_polar/AR_ID_config_CESM2-LE_AR_calc_{hemi}_2080-2099.hjson'

chunk_begin_t = dt.datetime(2080,1,1,0)
chunk_end_t = dt.datetime(2099,12,31,18)
timestep_hrs = '6'
