...
config_fpath = '/home/kmattingly/projects/AR_alg_v2/config_files/AR_ID_config_ERA5_global_IVT_magnitude_calc.hjson'
...
for file_t in output_file_times:
    ...
    os.system(f'python ../AR_alg_v2/calc_IVT_magnitude_ERA5.py {file_begin_t} {file_end_t} {timestep_hrs} {config_fpath}')
